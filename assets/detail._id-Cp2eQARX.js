import{r as y,j as f}from"./jsx-runtime-D2HyDbKh.js";import{u as L}from"./pb-data-utils-Bn6KpzTU.js";import{M as I}from"./index-neYQUp_0.js";import{B as H}from"./index-D9dO0-BM.js";import"./QueryClientProvider-1KH9_OfO.js";function F(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])}return e}function A(e,r){return Array(r+1).join(e)}function j(e){return e.replace(/^\n*/,"")}function $(e){for(var r=e.length;r>0&&e[r-1]===`
...
`}};o.fencedCodeBlock={filter:function(e,r){return r.codeBlockStyle==="fenced"&&e.nodeName==="PRE"&&e.firstChild&&e.firstChild.nodeName==="CODE"},replacement:function(e,r,t){for(var n=r.firstChild.getAttribute("class")||"",i=(n.match(/language-(\S+)/)||[null,""])[1],a=r.firstChild.textContent,s=t.fence.charAt(0),c=3,l=new RegExp("^"+s+"{3,}","gm"),u;u=l.exec(a);)u[0].length>=c&&(c=u[0].length+1);var m=A(s,c);return`
...
`.substring(0,i);return t+a+n}function oe(e){return e!=null&&(typeof e=="string"||e.nodeType&&(e.nodeType===1||e.nodeType===9||e.nodeType===11))}const ce=new p;function ue(e){const{id:r}=e,{data:t}=L(r),{title:n,subTitle:i,summary:a,description:s}=t,c=y.useMemo(()=>ce.turndown(s),[s]);return console.log(c),f.jsxs("div",{className:"m-auto max-w-md text-slate-50",children:[f.jsx("h1",{className:"my-4 text-center text-xl",children:n}),f.jsx("h2",{className:"text-right text-sm text-slate-400",children:i}),f.jsx("h3",{className:"text-slate-400",children:a}),f.jsx("div",{className:"mt-4",children:f.jsx(I,{components:{p:l=>{var C;const{node:u,...m}=l,h=(C=u==null?void 0:u.children)==null?void 0:C[0],g=[];return h&&h.type==="element"&&h.tagName==="img"?g.push("peer"):g.push("mb-6"),console.log(l),f.jsx("p",{className:g.join(" "),...m})},img:l=>f.jsx("img",{className:"",...l})},children:c})})]})}const fe=y.memo(ue);function me(e){const{id:r}=H();return f.jsx(f.Fragment,{children:r?f.jsx(fe,{id:r}):f.jsx(f.Fragment,{children:"Not found"})})}const Ne=y.memo(me);export{Ne as default};
